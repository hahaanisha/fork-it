    ...
    <div className="header">
      <div className="header-contents">
        ...
        <p className="text-amber-50 text-[20px]">
          Forkit makes food delivery effortless and fast. Browse through a
          variety of local restaurants, customize your meals, track your order
          in real-time, and have delicious food delivered straight to your
          doorstep.
        </p>
        <a href="#explore-menu">
